...
public class Parkour_1_20_4 extends Parkour {
    ...
    public Parkour_1_20_4() {
        this.player = new Player_1_20_4(DEFAULT_START, DEFAULT_VELOCITY, START_YAW, DEFAULT_POTION_EFFECTS);
        this.blockManager = new BlockManager_1_20_4();
        this.movement = new Movement_1_20_4(player, blockManager);
    }
