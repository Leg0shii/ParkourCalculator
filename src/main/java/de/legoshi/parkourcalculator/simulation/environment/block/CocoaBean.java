...
public class CocoaBean extends FacingBlock implements TierBlock {
    ...
    protected void calcSouth() {
        Vec3 lowerEdge = new Vec3(0.375 - addedSize, 0.4375 - addedSize * 2, 0.6875 - addedSize * 2);
        Vec3 upperEdge = new Vec3(0.625 + addedSize, 0.75, 0.9375);
        Vec3 shift = new Vec3(0.375 - addedSize, 0.3375 - addedSize, 0.375 - addedSize);
        this.axisVecTuples.add(constructBlock(lowerEdge, upperEdge, shift));
    }

    @Override
    protected void calcWest() {
        Vec3 lowerEdge = new Vec3(0.6875 - addedSize * 2, 0.4375 - addedSize * 2, 0.375 - addedSize);
    ...
    protected void calcNorth() {
        Vec3 lowerEdge = new Vec3(0.375 - addedSize, 0.4375 - addedSize * 2, 0.0625);
    ...
    protected void calcEast() {
        Vec3 lowerEdge = new Vec3(0.0625, 0.4375 - addedSize * 2, 0.375 - addedSize);
